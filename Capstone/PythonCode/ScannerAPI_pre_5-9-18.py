...
HOST = '131.181.139.36' #put the address of the computer running this code
...
def ChangeStatus():
    ...
    Com_setLongData(customAutoMode,'qctivqtion',driveType)
...
try:
    ...
    s.bind((HOST,PORT))
    s.listen(NUM_CONN) # This is blocking
    sc,ipAd = s.accept()
